...
//     var arrow = document.querySelector('.click_return');

//     if (window.pageYOffset > 350) {
//         arrow.classList.add('show_click_return');
//     } else {
//         arrow.classList.remove('show_click_return');
//     }
...
// accordions our offer

const accordeons_offer = document.querySelectorAll('.accordeon_offer_item');

for (item of accordeons_offer) {
    item.addEventListener('click', function() {
        this.classList.toggle('active');
    })
}
